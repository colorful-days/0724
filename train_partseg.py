...
def main(args):
    ...
    TRAIN_DATASET = PartNormalDataset(root = root, npoints=args.npoint, split='trainval', class_choice={ 'Cattle'},normal_channel=args.normal)
    trainDataLoader = torch.utils.data.DataLoader(TRAIN_DATASET, batch_size=args.batch_size,shuffle=True, num_workers=4)
    TEST_DATASET = PartNormalDataset(root = root, npoints=args.npoint, split='test',class_choice={ 'Cattle'}, normal_channel=args.normal)
